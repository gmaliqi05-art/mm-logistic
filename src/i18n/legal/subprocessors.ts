...
export const subprocessors = {
  ...
  sq: {
    ...
    intro: 'Ne perputhje me transparencen e kerkuar nga GDPR Art. 28(2), ketu eshte lista e plote e nen-perpunuesve (subprocessors) qe perdorim per te ofruar sherbimin [EMRI I PLATFORMES]. Cdo nen-perpunues ka nenshkruar nje marreveshje me ne qe i detyron te respektoje te paktet te njejtat standarte te mbrojtjes se te dhenave si ne. Lista perditesohet rregullisht dhe ndryshimet komunikohen 30 dite paraprakisht.',
  ...
  en: {
    ...
    intro: 'In accordance with the transparency required by GDPR Art. 28(2), here is the complete list of subprocessors we use to provide the [PLATFORM NAME] service. Each subprocessor has signed an agreement with us obligating them to respect at least the same data protection standards as we do. The list is updated regularly and changes are communicated 30 days in advance.',
  ...
  de: {
    ...
    intro: 'In \u00dcbereinstimmung mit der von Art. 28(2) DSGVO geforderten Transparenz hier die vollst\u00e4ndige Liste der Unterauftragsverarbeiter, die wir zur Bereitstellung des Dienstes [PLATTFORMNAME] verwenden. Jeder Unterauftragsverarbeiter hat eine Vereinbarung mit uns unterzeichnet, die ihn verpflichtet, mindestens die gleichen Datenschutzstandards wie wir einzuhalten. Die Liste wird regelm\u00e4\u00dfig aktualisiert und \u00c4nderungen werden 30 Tage im Voraus kommuniziert.',
  ...
  fr: {
    ...
    intro: 'Conform\u00e9ment \u00e0 la transparence requise par l\'Art. 28(2) du RGPD, voici la liste compl\u00e8te des sous-traitants ult\u00e9rieurs que nous utilisons pour fournir le service [NOM DE LA PLATEFORME]. Chaque sous-traitant a sign\u00e9 un accord avec nous l\'obligeant \u00e0 respecter au moins les m\u00eames normes de protection des donn\u00e9es que nous. La liste est mise \u00e0 jour r\u00e9guli\u00e8rement et les changements sont communiqu\u00e9s 30 jours \u00e0 l\'avance.',
    lastUpdated: '15 mai 2026',
    version: 'Version 1.0',
