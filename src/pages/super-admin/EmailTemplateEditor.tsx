...
export default function EmailTemplateEditor() {
  ...
  return (
    <div className="-m-4 flex flex-col lg:-m-6">
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 bg-white px-4 py-3 lg:px-6">
      ...
      <div className="flex min-h-0 flex-1 flex-col lg:flex-row">
        ...
        {showPreview && !isNew && tpl.code && (
          <div className="hidden shrink-0 border-t border-slate-200 bg-white p-4 lg:block lg:w-2/5 lg:border-l lg:border-t-0 xl:w-[480px]">
