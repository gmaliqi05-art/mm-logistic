  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Sinkronizo me Kontabilitetin</h1>
          <p className="text-slate-500 mt-1">Lidh fletedergesat me faturat ne modulin e kontabilitetit</p>
        </div>
        <button
          onClick={syncAll}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <Metric icon={TrendingUp} label="Fletedergesa dalese" value={String(totals.countOut)} color="emerald" />
