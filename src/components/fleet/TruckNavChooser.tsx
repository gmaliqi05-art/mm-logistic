      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto animate-in">
        <div className="sticky top-0 bg-white border-b border-slate-200 px-5 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold text-slate-900">{t('common.navigimPerKamiona')}</h2>
          </div>
        ...
        <div className="p-5 space-y-4">
          <div className="flex items-start gap-2 text-xs bg-amber-50 border border-amber-200 rounded-lg p-3 text-amber-900">
            ...
            <div>
              <div className="font-semibold">{t('common.mosPerdorGoogleMapsPerNavigim')}</div>
              <div className="mt-0.5">{t('common.googleMapsDheWazeNukKane')}</div>
            </div>
          </div>
