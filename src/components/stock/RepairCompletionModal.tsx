        ...
        {loading ? (
          ...
          <div className="p-5 space-y-4">
            <div className="rounded-lg bg-amber-50 border border-amber-200 px-4 py-3 text-center">
              <p className="text-[10px] uppercase tracking-wide text-amber-600 font-medium">{t('common.stokuDefektIDisponueshem')}</p>
            ...
            <div className="flex justify-end gap-2 pt-2">
              <button onClick={onClose} className="px-4 py-2 text-sm rounded-lg text-slate-700 hover:bg-slate-100">{t('common.cancel')}</button>
              <button
                onClick={submit}
