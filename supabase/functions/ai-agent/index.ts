...
const DEPOT_TOOLS: Tool[] = [
  ...
  },
  {
    ...
    input_schema: { type: "object", required: ["page"], properties: {
      ...
      items: { type: "array", description: "sorting: list of ANY products by name with quantities (use when the products are not simple Klasse A/B/C — every batch can have different products)", items: { type: "object", properties: { name: { type: "string" }, qty: { type: "number" } } } },
